static PyMethodDef methods_cv[] = {
    ...
    {"CirclesGridFinderParameters", (PyCFunction)pyopencv_cv_CirclesGridFinderParameters_CirclesGridFinderParameters, METH_VARARGS | METH_KEYWORDS, "CirclesGridFinderParameters() -> <CirclesGridFinderParameters object>"},
    ...
    {"findCirclesGrid", (PyCFunction)pyopencv_cv_findCirclesGrid, METH_VARARGS | METH_KEYWORDS, "findCirclesGrid(image, patternSize, flags, blobDetector, parameters[, centers]) -> retval, centers  or  findCirclesGrid(image, patternSize[, centers[, flags[, blobDetector]]]) -> retval, centers"},
    ...
    {"recoverPose", (PyCFunction)pyopencv_cv_recoverPose, METH_VARARGS | METH_KEYWORDS, "recoverPose(E, points1, points2, cameraMatrix[, R[, t[, mask]]]) -> retval, R, t, mask  or  recoverPose(E, points1, points2[, R[, t[, focal[, pp[, mask]]]]]) -> retval, R, t, mask  or  recoverPose(E, points1, points2, cameraMatrix, distanceThresh[, R[, t[, mask[, triangulatedPoints]]]]) -> retval, R, t, mask, triangulatedPoints"},
